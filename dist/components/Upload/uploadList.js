...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "df-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "df-upload-list-item", key: item.uid },
