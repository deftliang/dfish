...
export var AutoComplete = function (props) {
    ...
    var generateDropdown = function () {
        ...
        , { 
            // @ts-ignore
            in: showDropdown || loading, animation: "zoom-in-top", timeout: 300, onExited: function () {
                setSugestions([]);
            } },
            React.createElement("ul", { className: "df-suggestion-list", "data-testid": "test-list" },
    ...
    return (React.createElement("div", { className: "df-auto-complete", ref: componentRef },
